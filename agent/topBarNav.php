      ...
      <nav class="main-header navbar navbar-expand navbar-light shadow text-sm">
        ...
        <ul class="navbar-nav">
          ...
          <li class="nav-item d-none d-sm-inline-block">
            <a href="<?php echo base_url ?>" class="nav-link"><?php echo (!isMobileDevice()) ? $_settings->info('name'):$_settings->info('short_name'); ?> - Agent Portal</a>
          </li>
        </ul>
        <!-- Right navbar links -->
          ...
          <li class="nav-item">
            <div class="btn-group nav-link">
                  ...
                  <div class="dropdown-menu" role="menu">
                    <a class="dropdown-item" href="<?php echo base_url.'agent/?page=profile' ?>"><span class="fa fa-user"></span> My Account</a>

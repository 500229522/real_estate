...
<!-- Main Sidebar Container -->
      <aside class="main-sidebar sidebar-dark-dark elevation-4 sidebar-no-expand">
        <!-- Brand Logo -->
                ...
                <nav class="mt-4">
                   <ul class="nav nav-pills nav-sidebar flex-column text-sm nav-compact nav-flat nav-child-indent nav-collapse-hide-child" data-widget="treeview" role="menu" data-accordion="false">
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>buyer/?page=dashboard" class="nav-link nav-home">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>buyer/?page=list" class="nav-link nav-real_estate_manage_estate">
                    ...
                    <li class="nav-item dropdown">
                      <a href="<?php echo base_url ?>buyer/?page=agent_list" class="nav-link nav-real_estate">
